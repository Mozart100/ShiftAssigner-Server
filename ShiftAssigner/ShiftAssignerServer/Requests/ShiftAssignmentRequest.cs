...
public class ShiftAssignmentRequest
{
    ...
    // Optional ISO date yyyy-MM-dd for the period end (top period). If empty, assignment is for a single-day/periodStart.
    public string PeriodEnd { get; set; } = string.Empty;
    // Tenant (company) this assignment belongs to
